...
import { FiArrowLeft, FiEdit, FiTrash2, FiCalendar, FiMapPin, FiDollarSign, FiClock, FiUser, FiTag, FiCheck, FiX } from 'react-icons/fi';
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{prestation.prestataire_nom}</p>
                  </div>
                </div>
                <div>
