        ...
        const mockCollaborations = [
          {
            ...
            review: {
              rating: 4,
              comment: "Client satisfait, bonne communication et paiement à temps.",
              date: "2024-03-01",
              auteur: "prestataire"
            },
          ...
          },
          {
            ...
            review: {
              rating: 5,
              comment: "Excellente collaboration, projet bien défini et équipe réactive.",
              date: "2024-01-20",
              auteur: "prestataire"
            },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gérez et évaluez vos collaborations avec les fournisseurs</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-orange-100 text-sm">Revenu total</p>
        ...
        {filteredAndSortedCollaborations.length === 0 ? (
          <div className="text-center py-16">
            <div className="text-gray-500">
              ...
              <p className="text-gray-600">Commencez par collaborer avec des fournisseurs</p>
            </div>
          </div>
        ) : (
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center mt-1 text-sm text-gray-600">
                            <FiStar className="mr-1 h-3 w-3 text-yellow-400" />
                            {selectedCollaboration.fournisseur?.note_moyenne || 'N/A'}
                          </div>
