...
import { FiFilter, FiCalendar, FiMapPin, FiUser, FiStar, FiBriefcase, FiAlertCircle, FiChevronDown, FiEye, FiMessageSquare, FiThumbsUp, FiThumbsDown, FiClock, FiCheckCircle, FiXCircle } from 'react-icons/fi';
...
const MesCollaborations = () => {
  ...
  useEffect(() => {
    const fetchCollaborations = async () => {
      try {
        ...
        // Simuler la récupération des collaborations (à remplacer avec l'API réelle)
        const mockCollaborations = [
          {
            ...
            date_fin: "2024-02-28",
            budget: 2500000,
            description: "Création d'un site e-commerce complet avec panier et paiement en ligne",
            review: {
              rating: 5,
              comment: "Excellent travail, livré dans les temps. Très professionnel.",
              date: "2024-03-01",
              auteur: "fournisseur"
            },
          ...
          {
            id: 2,
            titre: "Design graphique pour application mobile",
            prestataire: {
              id: 2,
              nom: "Marie Sarr",
            ...
            date_fin: "2024-03-15",
            budget: 800000,
            description: "Création des maquettes et interfaces pour une application mobile",
            review: null,
            created_at: "2024-01-25"
          },
          {
            id: 3,
            titre: "Consulting marketing digital",
            prestataire: {
              id: 3,
              nom: "Ahmed Diop",
            ...
            date_fin: "2024-01-15",
            budget: 1500000,
            description: "Stratégie marketing digital pour lancement produit",
            review: {
              rating: 4,
              comment: "Bonne expertise, mais communication à améliorer.",
              date: "2024-01-20",
              auteur: "fournisseur"
            },
  ...
  const filteredAndSortedCollaborations = collaborations
    .filter(collaboration => {
      const matchesSearch = 
        ...
        collaboration.prestataire?.nom?.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const handleSubmitReview = async () => {
    try {
      // Simuler l'envoi du review (à remplacer avec l'API réelle)
      const updatedCollaborations = collaborations.map(c => 
        c.id === reviewData.collaboration_id 
          ? {
              ...c,
              review: {
      ...
      setToast({
        message: 'Review publié avec succès',
        type: 'success'
      });
    } catch (error) {
      console.error('Erreur lors de la publication du review:', error);
      setToast({
        message: 'Erreur lors de la publication du review',
        type: 'error'
      });
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gérez et évaluez vos collaborations avec les prestataires</p>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="avec_review">Avec review</option>
                <option value="sans_review">Sans review (terminées)</option>
              </select>
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors appearance-none"
              >
                <option value="created_at">Date de début</option>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 text-sm">Reviews</p>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-orange-100 text-sm">Budget total</p>
        ...
        {filteredAndSortedCollaborations.length === 0 ? (
          <div className="text-center py-16">
            <div className="text-gray-500">
              ...
              <p className="text-gray-600">Commencez par collaborer avec des prestataires</p>
            </div>
          </div>
        ) : (
                  ...
                  <tr key={collaboration.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-sm font-medium text-gray-900">
                            {collaboration.prestataire?.nom}
                          </div>
                          <div className="flex items-center text-xs text-gray-500">
                            <FiStar className="mr-1 h-3 w-3 text-yellow-400" />
                            {collaboration.prestataire?.note_moyenne || 'N/A'}
                          </div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900">
                        <div>{new Date(collaboration.date_debut).toLocaleDateString('fr-FR')}</div>
                        <div className="text-gray-500">au</div>
                        <div>{new Date(collaboration.date_fin).toLocaleDateString('fr-FR')}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-semibold text-gray-900">
            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center text-sm">
                        ...
                        <span className="ml-2 font-medium">
                          {new Date(selectedCollaboration.date_debut).toLocaleDateString('fr-FR')}
                        </span>
                      </div>
                      <div className="flex items-center text-sm">
                        <FiCalendar className="mr-2 h-4 w-4 text-gray-400" />
                        ...
                        <span className="ml-2 font-medium">
                          {new Date(selectedCollaboration.date_fin).toLocaleDateString('fr-FR')}
                        </span>
                      </div>
                      <div className="flex items-center text-sm">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Prestataire</h3>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">{selectedCollaboration.prestataire?.nom}</p>
                          <div className="flex items-center mt-1 text-sm text-gray-600">
                            <FiStar className="mr-1 h-3 w-3 text-yellow-400" />
                            {selectedCollaboration.prestataire?.note_moyenne || 'N/A'}
                          </div>
                          <div className="text-sm text-gray-600">
                            {selectedCollaboration.prestataire?.email}
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-lg w-full">
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Laisser un Review</h2>
