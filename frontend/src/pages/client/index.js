...
export { default as BesoinCreate } from './besoin/BesoinCreate';
/** @deprecated utiliser BesoinCreate */
export { default as CreerDemande } from './besoin/BesoinCreate';
export { default as MesBesoins } from './besoin/MesBesoins';
/** @deprecated utiliser MesBesoins */
export { default as MesDemandes } from './besoin/MesBesoins';
export { default as ClientTransactions } from './transactions/MesTransactions';
...
export { default as DemandeDetail } from './besoin/BesoinDetail';
