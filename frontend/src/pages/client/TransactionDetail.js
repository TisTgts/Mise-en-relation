...
import { FiArrowLeft, FiEdit, FiCheck, FiX, FiClock, FiCalendar, FiDollarSign, FiUser, FiMapPin, FiMessageSquare, FiFileText } from 'react-icons/fi';
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-medium text-gray-900 mb-2">Demande</h3>
                  <p className="text-sm font-medium text-green-600">{transaction.demande?.intitule}</p>
                  <p className="text-sm text-gray-600">{transaction.demande?.lieu_intervention}</p>
                  <p className="text-sm text-gray-500 mt-1">Urgence: {transaction.demande?.urgence}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Prestataire</p>
                    <p className="text-sm text-gray-900 font-medium">{transaction.prestataire_nom}</p>
                    <p className="text-sm text-gray-500">{transaction.prestataire?.email}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
